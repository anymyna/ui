 ...
 * Created i
 */
public class EasyPermissionsFragment extends Fragment implements EasyPermissions.PermissionCallbacks {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        // Create view
        View v = inflater.inflate(R.layout.easy_permissions_main, container);
